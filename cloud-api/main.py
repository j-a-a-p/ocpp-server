...
from routes import residents, cards, auth, charge_transactions, power_logs, charging_costs, charging_profiles
...
app.include_router(charging_profiles.router, prefix="/charging-profiles", tags=["charging-profiles"])
app.add_middleware(
    CORSMiddleware,
